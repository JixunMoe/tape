...
var deepEqual = require('../utils/deep-equal');

var inherits = require('util').inherits;

var has = deref(Object.prototype.hasOwnProperty);
var forEach = deref(Array.prototype.forEach);
var isEnumerable = deref(Object.prototype.propertyIsEnumerable);
var toLowerCase = deref(String.prototype.toLowerCase);
var trim = deref(String.prototype.trim);
var $test = deref(RegExp.prototype.test);
